...
#$ -l scratch=10G      # job requires up to 2 GiB of local /scratch space
...
conda activate NSF38
cd /wynton/home/engelhardt/chwu/Projects/HubID/SpatialLDA
pwd
python ./scripts/G4423.py
...
##### qsub -cwd -l scratch=200G ./examples/example_antibiotics.py